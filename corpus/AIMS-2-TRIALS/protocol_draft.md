...
> To assess how each retained article reports autistic participation using the GRIPP2-LF checklist, while balancing rigour with limited resources. Only a subset of articles is double-coded; statistical checks ensure that single coding of the remainder remains valid.
=======
...
→
>>>>>>> 75a3fef8d4b4612541987d9185ff9fb05af5ac56
